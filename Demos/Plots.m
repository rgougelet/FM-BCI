...
%% Optimal 1: neig = 21, eig_mag = 0.95 (old MSE = 2.81370667385737e-14)
...
for i = 1:199
    for j = 1:19
        Z_2(j,i) = optimal_2_MSE(i*j);
    end
end

disp('Optimal 2: neig = 21, eig_mag = 0.94, N = 18200, n = 4, MSE = 1.22996188683398e-14');
zmax = .05;
...
for i = 1:199
    for j = 1:19
        Z_3(j,i) = optimal_3_MSE(i*j);
    end
end

disp('Optimal 3: nieg = 27, eig_mag = .89,  N = 8400, n = 4, MSE = 3.84267677942265e-14');
zmax = .05;
...
for i = 1:199
    for j = 1:19
        Z_4(j,i) = optimal_4_MSE(i*j);
    end
end

disp('Optimal 4: neig = 17, eig_mag = .94, N = 17500, n = 4, MSE = 4,2.39344394938992e-14');
zmax = .001;
...
for i = 1:199
    for j = 1:19
        Z_5(j,i) = optimal_5_MSE(i*j);
    end
end

disp('Optimal 5: neig = 24, eig_mag = .93, N = 17000, n = 4, MSE = 2.34173430089391e-13');
zmax = .05;
